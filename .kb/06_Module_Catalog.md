...
| [Authentication](Modules/Authentication.md) | api + web | Proves who a caller is and issues the session they act under. Password and phone-OTP, refresh rotation with reuse detection. | 10 | 5 |
...
| [PlatformConsole](Modules/PlatformConsole.md) | api + web | What the platform operator sees. Demo-request pipeline, provisioning, and eventually impersonation. | 2 | 2 |
