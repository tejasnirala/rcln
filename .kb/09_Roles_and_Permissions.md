...
12 system roles · 137 permissions.
...
| --- | --- | --- | --- | --- |
| `SUPER_ADMIN` | Super Admin | PLATFORM | 137 / 137 | Platform operator. Seeded directly into the database, never created via the UI. |
| `ORG_OWNER` | Organization Owner | ORGANIZATION | 121 / 137 | Registered the clinic. Full control including subscription and billing. |
| `ORG_ADMIN` | Organization Admin | ORGANIZATION | 117 / 137 | Manages every branch, but cannot change the subscription or delete the org. |
| `BRANCH_ADMIN` | Branch Admin | BRANCH | 86 / 137 | Runs one or more branches. Which branches is decided per assignment in membership_roles, not here. |
| `DOCTOR` | Doctor | BRANCH | 37 / 137 | Consults patients. Scoped to the branches they practise at. |
| `NURSE` | Nurse | BRANCH | 20 / 137 | Records vitals, assists the encounter, manages the queue. |
| `RECEPTIONIST` | Receptionist / Front Desk | BRANCH | 24 / 137 | Registers patients, books appointments, collects payment. No clinical access. |
| `LAB_ASSISTANT` | Lab Assistant | BRANCH | 6 / 137 | Collects samples and enters results. Cannot verify or release a report. |
| `LAB_MANAGER` | Lab Manager | BRANCH | 18 / 137 | Verifies results and releases reports. Separation of duty from the assistant. |
| `PHARMACIST` | Pharmacist | BRANCH | 41 / 137 | Dispenses against prescriptions and manages stock. |
| `ACCOUNTANT` | Accountant | ORGANIZATION | 25 / 137 | Billing and revenue. Reads patient identity only, never clinical notes. |
| `PATIENT` | Patient | ORGANIZATION | 11 / 137 | Portal access to their own records only. Row filtering is by patient_id, not by this role. |
...
| permission | SUPER ADMIN | ORG OWNER | ORG ADMIN | BRANCH ADMIN | DOCTOR | NURSE | RECEPTIONIST | LAB ASSISTANT | LAB MANAGER | PHARMACIST | ACCOUNTANT | PATIENT |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `billing.charge_policy.manage` | Y | Y | Y |  |  |  |  |  |  |  | Y |  |
| `billing.charge_request.manage` | Y | Y | Y | Y |  |  | Y |  |  |  | Y |  |
| `billing.charge_request.read` | Y | Y | Y | Y |  |  | Y |  |  | Y | Y |  |
...
| `clinical.template.manage` | Y | Y | Y |  |  |  |  |  |  |  |  |  |
| `clinical.visual_map.manage` | Y | Y | Y |  |  |  |  |  |  |  |  |  |
...
| permission | SUPER ADMIN | ORG OWNER | ORG ADMIN | BRANCH ADMIN | DOCTOR | NURSE | RECEPTIONIST | LAB ASSISTANT | LAB MANAGER | PHARMACIST | ACCOUNTANT | PATIENT |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `consumption.override` | Y | Y | Y |  | Y | Y |  |  |  |  |  |  |
| `consumption.record` | Y | Y | Y |  | Y | Y |  |  |  |  |  |  |
| `consumption.record.read` | Y | Y | Y | Y | Y | Y |  |  |  | Y |  |  |
| `consumption.template.manage` | Y | Y | Y | Y |  |  |  |  |  |  |  |  |
...
| `inventory.location.manage` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `inventory.reason_code.manage` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `inventory.stock.adjust` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `inventory.stock.read` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `inventory.stock.reserve` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
...
| `pharmacy.online_order.dispatch` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `pharmacy.online_order.manage` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `pharmacy.online_order.read` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
...
| permission | SUPER ADMIN | ORG OWNER | ORG ADMIN | BRANCH ADMIN | DOCTOR | NURSE | RECEPTIONIST | LAB ASSISTANT | LAB MANAGER | PHARMACIST | ACCOUNTANT | PATIENT |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `procurement.requisition.approve` | Y | Y | Y | Y |  |  |  |  |  |  |  |  |
| `procurement.requisition.create` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
...
| `product.regulatory.manage` | Y | Y | Y | Y |  |  |  |  | Y | Y |  |  |
| `product.regulatory.read` | Y | Y | Y | Y | Y |  |  |  | Y | Y |  |  |

### recall

| permission | SUPER ADMIN | ORG OWNER | ORG ADMIN | BRANCH ADMIN | DOCTOR | NURSE | RECEPTIONIST | LAB ASSISTANT | LAB MANAGER | PHARMACIST | ACCOUNTANT | PATIENT |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `recall.notice.create` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `recall.notice.execute` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `recall.notice.read` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |
| `recall.trace.patients` | Y | Y | Y | Y |  |  |  |  |  | Y |  |  |

### regulatory

| permission | SUPER ADMIN | ORG OWNER | ORG ADMIN | BRANCH ADMIN | DOCTOR | NURSE | RECEPTIONIST | LAB ASSISTANT | LAB MANAGER | PHARMACIST | ACCOUNTANT | PATIENT |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `regulatory.pack.approve` | Y |  |  |  |  |  |  |  |  |  |  |  |
| `regulatory.rule.manage` | Y |  |  |  |  |  |  |  |  |  |  |  |
| `regulatory.rule.read` | Y | Y | Y | Y | Y |  |  |  | Y | Y |  |  |
