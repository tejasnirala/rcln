...
Declared at `packages/db/prisma/schema/inventory.prisma:416`.
...
| `recallBatches` | [`RecallBatch`](RecallBatch.md) | `recallBatches RecallBatch[] @relation("RecallBatchBatch")` |
