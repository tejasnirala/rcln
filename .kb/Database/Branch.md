...
Declared at `packages/db/prisma/schema/tenancy.prisma:313`.
...
erDiagram
    ...
    Branch }o--o{ RecallBatch : relates
    Branch }o--o{ OnlineOrder : relates
    Branch }o--o{ OnlineOrderLine : relates
    Branch }o--o{ OnlineOrderShipment : relates
    ...
    Branch }o--o{ ClinicProfile : relates
```
