...
Declared at `packages/db/prisma/schema/pharmacy.prisma:168`.
...
| `onlineOrder` | [`OnlineOrder`](OnlineOrder.md) | `onlineOrder OnlineOrder? @relation("OnlineOrderDispense")` |
...
erDiagram
    ...
    Dispense }o--o{ OnlineOrder : relates
```
