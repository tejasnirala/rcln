...
Declared at `packages/db/prisma/schema/doctors.prisma:242`.
...
| `compensation` | [`DoctorCompensation`](DoctorCompensation.md) | `compensation DoctorCompensation?` |
| `fees` | [`FeeScheduleEntry`](FeeScheduleEntry.md) | `fees FeeScheduleEntry[]` |
| `invoices` | [`Invoice`](Invoice.md) | `invoices Invoice[] @relation("InvoicePractitioner")` |
...
| `referralsTo` | [`EncounterReferral`](EncounterReferral.md) | `referralsTo EncounterReferral[] @relation("ReferralDoctor")` |
...
erDiagram
    ...
    DoctorProfile }o--o{ DoctorCompensation : relates
    DoctorProfile }o--o{ FeeScheduleEntry : relates
    DoctorProfile }o--o{ Invoice : relates
    ...
    DoctorProfile }o--o{ EncounterReferral : relates
```
