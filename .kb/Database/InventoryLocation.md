...
Declared at `packages/db/prisma/schema/inventory.prisma:265`.
...
| `onlineOrders` | [`OnlineOrder`](OnlineOrder.md) | `onlineOrders OnlineOrder[] @relation("OnlineOrderLocation")` |
...
erDiagram
    ...
    InventoryLocation }o--o{ OnlineOrder : relates
