...
Declared at `packages/db/prisma/schema/products.prisma:612`.
...
| `onlineOrderLines` | [`OnlineOrderLine`](OnlineOrderLine.md) | `onlineOrderLines OnlineOrderLine[] @relation("OnlineOrderLineProduct")` |
...
erDiagram
    ...
    Product }o--o{ OnlineOrderLine : relates
