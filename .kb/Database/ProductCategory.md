...
Declared at `packages/db/prisma/schema/products.prisma:380`.
...
| `chargePolicyRules` | [`ChargePolicyRule`](ChargePolicyRule.md) | `chargePolicyRules ChargePolicyRule[] @relation("ChargePolicyRuleCategory")` |
...
erDiagram
    ...
    ProductCategory }o--o{ ChargePolicyRule : relates
```
