...
Declared at `packages/db/prisma/schema/access-control.prisma:81`.
...
| `designations` | [`RoleDesignation`](RoleDesignation.md) | `designations RoleDesignation[]` |
...
erDiagram
    ...
    Role }o--o{ RoleDesignation : relates
```
