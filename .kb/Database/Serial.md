...
Declared at `packages/db/prisma/schema/inventory.prisma:520`.
...
| `goodsReceiptLines` | [`GoodsReceiptLine`](GoodsReceiptLine.md) | `goodsReceiptLines GoodsReceiptLine[] @relation("GoodsReceiptLineSerial")` |
| `purchaseReturnLines` | [`PurchaseReturnLine`](PurchaseReturnLine.md) | `purchaseReturnLines PurchaseReturnLine[] @relation("PurchaseReturnLineSerial")` |
| `dispenseAllocations` | [`DispenseAllocation`](DispenseAllocation.md) | `dispenseAllocations DispenseAllocation[] @relation("DispenseAllocationSerial")` |
| `consumptionAllocations` | [`ConsumptionAllocation`](ConsumptionAllocation.md) | `consumptionAllocations ConsumptionAllocation[] @relation("ConsumptionAllocationSerial")` |
...
erDiagram
    ...
    Serial }o--o{ GoodsReceiptLine : relates
    Serial }o--o{ PurchaseReturnLine : relates
    Serial }o--o{ DispenseAllocation : relates
    Serial }o--o{ ConsumptionAllocation : relates
```
