...
Declared at `packages/db/prisma/schema.prisma:1613`.
...
| `parent` | [`Specialty`](Specialty.md) | `parent Specialty? @relation("SpecialtyParent", fields: [parentId], references: [id], onDelete: SetNull)` |
