...
| `consumptionLines` | [`ConsumptionLine`](ConsumptionLine.md) | `consumptionLines ConsumptionLine[] @relation("ConsumptionLineUnit")` |
...
erDiagram
    ...
    UnitOfMeasure }o--o{ ConsumptionLine : relates
```
