...
119 models · 94 enums · 92 tenant-scoped.
...
| `Specialty` | `organization: Organization?` `parent: Specialty?` `children: Specialty[]` `doctors: DoctorSpecialty[]` `clinicalScopes: ClinicalMasterScope[]` `productScopes: ProductClinicalScope[]` `clinicalEpisodes: ClinicalEpisode[]` |
