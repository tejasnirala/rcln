...
| `hasPermission` | fn | `apps/api/src/services/auth/access.service.ts:279` |
...
| `invalidateOrganizationAccess` | fn | `apps/api/src/services/auth/access.service.ts:212` |
| `invalidateUserAccess` | fn | `apps/api/src/services/auth/access.service.ts:192` |
...
| `listMemberships` | fn | `apps/api/src/services/auth/access.service.ts:333` |
| `loadAuthenticatedUser` | fn | `apps/api/src/services/auth/login.service.ts:141` |
| `loadUserAccess` | fn | `apps/api/src/services/auth/access.service.ts:171` |
...
| `MembershipSummaryRow` | interface | `apps/api/src/services/auth/access.service.ts:303` |
| `organizationBranchIds` | fn | `apps/api/src/services/auth/access.service.ts:239` |
| `OtpRequestOutcome` | interface | `apps/api/src/services/auth/otp.service.ts:24` |
| `permissionsFor` | fn | `apps/api/src/services/auth/access.service.ts:270` |
...
| `toAccessContext` | fn | `apps/api/src/services/auth/access.service.ts:254` |
| `UserAccess` | interface | `apps/api/src/services/auth/access.service.ts:52` |
