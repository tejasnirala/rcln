...
| `loadProfile` <sub>local</sub> | `(tx: TxClient, productId: string, place: Jurisdiction, on: Date): Promise<ProductRegulatoryProfile \| null>` | `apps/api/src/services/regulatory/evaluation.service.ts:166` |  |
