...
Files: `apps/api/tests/unit/audit-diff.test.ts` · `apps/api/tests/unit/charge-policy.test.ts` · `apps/api/tests/unit/credit-note-contract.test.ts` · `apps/api/tests/unit/inventory-allocation.test.ts` · `apps/api/tests/unit/inventory-movement.test.ts` · `apps/api/tests/unit/procurement-costing.test.ts` · `apps/api/tests/unit/product-units.test.ts` · `apps/api/tests/unit/product-values.test.ts` · `apps/api/tests/unit/regulatory-enforcement.test.ts` · `apps/api/tests/unit/route-gates.test.ts` · `apps/api/tests/unit/storage-path.test.ts` · `apps/api/tests/unit/temperature.test.ts` · `apps/api/tests/unit/vital-ranges.test.ts`

## fn

| name | signature | at | notes |
| --- | --- | --- | --- |
| `chainOf` <sub>local</sub> | `(router: IRouter): string[]` | `apps/api/tests/unit/route-gates.test.ts:207` |  |
