...
| `ConsultationEngine` | `({ slug, appointmentId, encounter, canWrite, canFinalize, ca…)` | `apps/web/src/components/tenant/consultation-engine.tsx:115` |  |
...
| `ONSETS` <sub>local</sub> | `[ { value: 'SUDDEN', label: 'Sudden' }, { value: 'GRADUAL', label: 'Gradual' }, { value: …` | `apps/web/src/components/tenant/consultation-engine.tsx:87` |  |
...
| `SectionBody` <sub>local</sub> | `({ section, draft, edit, setSectionField, readOnly, slug, }:…)` | `apps/web/src/components/tenant/consultation-engine.tsx:377` |  |
...
| `draftFrom` <sub>local</sub> | `(encounter: EncounterDetail): Draft` | `apps/web/src/components/tenant/consultation-engine.tsx:61` |  |
...
| `AUTOSAVE_DELAY_MS` <sub>local</sub> | `1200` | `apps/web/src/components/tenant/consultation-engine.tsx:48` |  |
...
| `DURATION_UNITS` <sub>local</sub> | `[ { value: 'HOURS', label: 'hours' }, { value: 'DAYS', label: 'days' }, { value: 'WEEKS',…` | `apps/web/src/components/tenant/consultation-engine.tsx:79` |  |
...
| `PENDING_SECTIONS` <sub>local</sub> | `: Record<string, string>` | `apps/web/src/components/tenant/consultation-engine.tsx:102` |  |
...
| `STATUS_WORDS` <sub>local</sub> | `: Record<string, string>` | `apps/web/src/components/tenant/consultation-engine.tsx:494` |  |
...
| `Draft` <sub>local</sub> | `{ chiefComplaint, durationValue, durationUnit, onset, clinicalNotes, sections }` | `apps/web/src/components/tenant/consultation-engine.tsx:52` |  |
...
| `SectionAnswers` <sub>local</sub> | `Record<string, Record<string, FieldValue>>` | `apps/web/src/components/tenant/consultation-engine.tsx:50` |  |
