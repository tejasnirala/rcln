...
Files: `packages/inventory/src/errors.ts` · `packages/inventory/src/expiry.ts` · `packages/inventory/src/index.ts` · `packages/inventory/src/movement.ts` · `packages/inventory/src/units.ts`
...
| `negate` <sub>local</sub> | `(quantity: string): string` | `packages/inventory/src/movement.ts:387` | Negate a decimal string without going through a float. |
...
| `recordMovementIn` | `(tx: TxClient, ctx: TenantContext, deps: MovementDeps, input: MovementInput, options: MovementOptions): Promise<RecordMovementResponse>` | `packages/inventory/src/movement.ts:400` |  |
...
| `toBaseUnits` <sub>local</sub> | `(tx: TxClient, deps: MovementDeps, product: { id: string; baseUnitId: string; baseUnitCode: st…, input: Pick<MovementInput, 'quantity' \| 'unitId' \| 'packagi…): Promise<string>` | `packages/inventory/src/movement.ts:337` |  |
