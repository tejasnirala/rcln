...
| `moduleOf` | `(code: PermissionCode): string` | `packages/permissions/src/codes.ts:847` | Split `pharmacy.dispense.create` into its module for grouping in the UI. |
...
| name | signature | at | notes |
| --- | --- | --- | --- |
| `ALL_PERMISSIONS` | `Object.values(PERMISSIONS) as PermissionCode[]` | `packages/permissions/src/codes.ts:844` |  |
...
| `PermissionCode` | `(typeof PERMISSIONS)[keyof typeof PERMISSIONS]` | `packages/permissions/src/codes.ts:842` |  |
