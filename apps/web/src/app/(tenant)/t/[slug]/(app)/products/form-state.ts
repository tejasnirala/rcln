...
import type { MasterFormState } from './masters-actions';

export const IDLE_FORM: ProductFormState = { status: 'idle' };

/** The same, for the five catalogue master screens. See `masters-actions.ts`. */
export const IDLE_MASTER_FORM: MasterFormState = { status: 'idle' };
