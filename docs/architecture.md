...
Companion to `docs/schema/schema-design.md`. Assumes India-first (GST, HSN, ABHA all appear in the schema), Postgres 16, and the existing `expresswithpsql` scaffold as the backend seed.
